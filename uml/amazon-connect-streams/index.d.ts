 ...
 */
type UserBackgroundBlurChangeCallback = (
  UserBackgroundBlurChange: UserBackgroundBlurChange
) => void;
 ...
 */
declare function agent(callback: AgentCallback): void;
 ...
 */
declare function contact(callback: ContactCallback): void;
 ...
 */
declare function onWebsocketInitFailure(callback: Callback): void;
 ...
 */
declare function hitch<T extends (...args: any[]) => any>(
  scope: object,
  method: T
): T;
...
declare const storageAccess: StorageAccess;
...
declare const agentApp: AgentApp;
...
declare enum ConnectionStateType {
...
declare enum CONTACT_ACTIVE_STATES {
  INCOMING = "incoming",
  PENDING = "pending",
  CONNECTING = "connecting",
  CONNECTED = "connected",
...
declare enum SoftphoneCallType {
...
declare enum SoftphoneErrorTypes {
...
declare enum MonitoringMode {
  SILENT_MONITOR = "SILENT_MONITOR",
  BARGE = "BARGE",
}

declare enum MasterTopics {
...
declare class QuickResponses {
   ...
   */
  static searchQuickResponses(
    params: QuickResponsesQuery
 ...
 * If you need to, store the `contactId` and `connectionId` of the connection and make sure that the contact and connection still exist by fetching them in order from the `Agent` API object before calling methods on them.
 */
declare class VoiceConnection extends BaseConnection {
  ...
  enrollSpeakerInVoiceId(
    callbackOnAudioCollectionComplete?: Function
  ): Promise<any>;
 ...
 * If you need to, store the `contactId` and `connectionId` of the connection and make sure that the contact and connection still exist by fetching them in order from the `Agent` API object before calling methods on them.
 */
declare class ChatConnection extends BaseConnection {
 ...
 * If you need to, store the `contactId` and `connectionId` of the connection and make sure that the contact and connection still exist by fetching them in order from the `Agent` API object before calling methods on them.
 */
declare class TaskConnection extends BaseConnection {
  /** Get the media info object associated with this connection. */
...
declare function getLog(): Logger;
